...
#include "DIO_DRIVER_Priv.h"
#include "DIO_DRIVER.h"

DIO_ERROR_RETVAL_t DIO_PortInit (DIO_PORT_ID_t DIO_port, DIO_DIRECTION_t DIO_direction)
{
	...
	if ((DIO_port <= PORTD)&& (DIO_direction==PORT_INPUT || DIO_direction==PORT_OUTPUT))
	{
		switch (DIO_port)
		{
		case     PORTA: WRITE_REG(DDRA_Register, DIO_direction); break;
		case     PORTB: WRITE_REG(DDRB_Register, DIO_direction); break;
		case     PORTC: WRITE_REG(DDRC_Register, DIO_direction); break;
		case     PORTD: WRITE_REG(DDRD_Register, DIO_direction); break;
		default: ErrorValue = EXIT_FAILURE;			  			 break;
		}
	}
	else
	{
...
DIO_ERROR_RETVAL_t DIO_PinInit (DIO_PORT_ID_t DIO_port, DIO_PIN_ID_t DIO_pin, DIO_DIRECTION_t DIO_direction)
{
	DIO_ERROR_RETVAL_t ErrorValue = EXIT_SUCCESFUL;
	...
	if ((DIO_port <= PORTD) && (DIO_pin <= PIN7))
	{
		if ( DIO_direction == PIN_OUTPUT )
		{
			...
			switch (DIO_port)
			{
			case PORTA: SET_BIT(DDRA_Register,DIO_pin); break;
			case PORTB: SET_BIT(DDRB_Register,DIO_pin); break;
			case PORTC: SET_BIT(DDRC_Register,DIO_pin); break;
			case PORTD: SET_BIT(DDRD_Register,DIO_pin); break;
			default: ErrorValue = EXIT_FAILURE;	break;
			}
		}
		else if ( DIO_direction == PIN_INPUT )
		{
			...
			switch (DIO_port)
			{
			case PORTA: CLEAR_BIT(DDRA_Register,DIO_pin); break;
			case PORTB: CLEAR_BIT(DDRB_Register,DIO_pin); break;
			case PORTC: CLEAR_BIT(DDRC_Register,DIO_pin); break;
			case PORTD: CLEAR_BIT(DDRD_Register,DIO_pin); break;
			default: ErrorValue = EXIT_FAILURE;			  break;
			}
		}
...
DIO_ERROR_RETVAL_t DIO_PinEnablePullUp (DIO_PORT_ID_t DIO_port, DIO_PIN_ID_t DIO_pin)
{
	DIO_ERROR_RETVAL_t ErrorValue = EXIT_SUCCESFUL;
	if ((DIO_port <= PORTD) && (DIO_pin <= PIN7))
	{
...
DIO_ERROR_RETVAL_t DIO_SetPinVal (DIO_PORT_ID_t DIO_port, DIO_PIN_ID_t DIO_pin, Byte value)
{
...
Byte DIO_GetPortVal (DIO_PORT_ID_t DIO_port)
{
	...
	if ((DIO_port <= PORTD))
	{
		...
		switch (DIO_port)
		{
		case PORTA: RETVAL = READ_REG(PINA_Register); break;
		case PORTB: RETVAL = READ_REG(PINB_Register); break;
		case PORTC: RETVAL = READ_REG(PINC_Register); break;
		case PORTD: RETVAL = READ_REG(PIND_Register); break;
		default: RETVAL = EXIT_FAILURE;     		  break;
		}
	}
	else
	{
...
Byte DIO_GetPinVal (DIO_PORT_ID_t DIO_port, DIO_PIN_ID_t DIO_pin)
{
	...
	if ((DIO_port <= PORTD) && (DIO_pin <= PIN7))
	{
		...
		switch (DIO_port)
		{                                           
		case PORTA: RETVAL = READ_BIT(PINA_Register, DIO_pin); break;
		case PORTB: RETVAL = READ_BIT(PINB_Register, DIO_pin); break;
		case PORTC: RETVAL = READ_BIT(PINC_Register, DIO_pin); break;
		case PORTD: RETVAL = READ_BIT(PIND_Register, DIO_pin); break;
		}
	}
	else
	{
