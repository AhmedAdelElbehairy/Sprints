...
#define TIMER_DRIVER_H_
	...
	TIM_ERROR_t TIM_Init (TIM_SELECT_t Timer, TIM_CLK_SELECT_t clock, TIMER_MODE_t timer_mode, TIM_CMPMATCH_OUTPUT_t compareMatch_output_mode, uint16_t counterValue, uint16_t compareValue);
