	...
	#define Unavailable_UART_Channel 2
	#define ReceiverBuffer_Is_Empty 3
	#define Transmission_Fail 4
	#define Receiving_Fail 5
	#define StringTransimission_Fail 6
	#define StringReceivingFail 7
	#define Setting_CallBack_Fail 8
	#define Interrupt_Disabling_Fail 9
	#define Interrupt_Enabling_Fail 10
